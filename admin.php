...
<div class="wrapper">
  <div class="top_navbar">
    ...
    <div class="top_menu">
      ...
      <ul>
        <li><a href="pages/admin/Actualiza.html">
          <i class="fas fa-cloud-upload-alt" title="Actualiza tus datos"></i></a></li>
        <li><a href="pages/admin/Cuenta.html">
  ...
  <div class="sidebar">
    <ul>
      ...
      <li><a href="pages/admin/ayuda.html">
